...
OVERVIEW_COLUMN_MAP = {
    ...
    "房间数": "rooms",
    "酒店面积": "build_area",
    "经营利润月实际值": "OPERATING_PROFIT_MTD_A",
    "经营利润月预算值": "OPERATING_PROFIT_MTD_B",
    "经营利润月去年同期": "OPERATING_PROFIT_MTD_L",
    "业主利润月实际": "OWNER_PROFIT_MTD_A",
    "业主利润月预算": "OWNER_PROFIT_MTD_B",
    "业主利润月去年同期": "OWNER_PROFIT_MTD_L",
    "月客房收入实际": "ROOM_INCOME_MTD_A",
    "月客房收入预算": "ROOM_INCOME_MTD_B",
    "月客房收入同期": "ROOM_INCOME_MTD_L",
    "月实际出租房间数": "RENTAL_ROOMS_NUM_MTD_A",
    "月预算出租房间数": "RENTAL_ROOMS_NUM_MTD_B",
    "月同期出租房间数": "RENTAL_ROOMS_NUM_MTD_L",
    "平均房价月实际": "AVE_HOUSE_PRICE_MTD_A",
    "平均房价月预算": "AVE_HOUSE_PRICE_MTD_B",
    "平均房价月同期": "AVE_HOUSE_PRICE_MTD_L",
    "入住率月实际": "OCCUPANCY_RATE_MTD_A",
    "入住率月预算": "OCCUPANCY_RATE_MTD_B",
    "入住率月同期": "OCCUPANCY_RATE_MTD_L",
    "每房收益月实际": "INCOME_PER_ROOM_MTD_A",
    "每房收益月预算": "INCOME_PER_ROOM_MTD_B",
    "每房收益月同期": "INCOME_PER_ROOM_MTD_L",
    "总收入月实际": "TOTAL_INCOME_MTD_A",
    "总收入月预算": "TOTAL_INCOME_MTD_B",
    "总收入月同期": "TOTAL_INCOME_MTD_L",
    "餐厅收入月实际": "RESTAURANT_INCOME_MTD_A",
    "餐厅收入月预算": "RESTAURANT_INCOME_MTD_B",
    "餐厅收入月同期": "RESTAURANT_INCOME_MTD_L",
    "宴会收入月实际": "BANQUET_INCOME_MTD_A",
    "宴会收入月预算": "BANQUET_INCOME_MTD_B",
    "宴会收入月同期": "BANQUET_INCOME_MTD_L",
    "其它营业部门收入月实际": "OTHER_DEPT_INCOME_MTD_A",
    "其它营业部门收入月预算": "OTHER_DEPT_INCOME_MTD_B",
    "其它营业部门收入月同期": "OTHER_DEPT_INCOME_MTD_L",
    "租金及其它收入月实际": "OTHER_RATE_INCOME_MTD_A",
    "租金及其它收入月预算": "OTHER_RATE_INCOME_MTD_B",
    "租金及其它收入月同期": "OTHER_RATE_INCOME_MTD_L",
    "客房成本月实际": "ROOM_COST_MTD_A",
    "客房成本月预算": "ROOM_COST_MTD_B",
    "客房成本月同期": "ROOM_COST_MTD_L",
    "餐饮成本月实际": "RESTAURANT_COST_MTD_A",
    "餐饮成本月预算": "RESTAURANT_COST_MTD_B",
    "餐饮成本月同期": "RESTAURANT_COST_MTD_L",
    "食品成本月实际": "FOOD_COST_MTD_A",
    "食品成本月预算": "FOOD_COST_MTD_B",
    "食品成本月同期": "FOOD_COST_MTD_L",
    "酒水成本月实际": "WINE_COSE_MTD_A",
    "酒水成本月预算": "WINE_COSE_MTD_B",
    "酒水成本月同期": "WINE_COSE_MTD_L",
    "行政费用月实际": "ADMINI_EXPENSES_MTD_A",
    "行政费用月预算": "ADMINI_EXPENSES_MTD_B",
    "行政费用月同期": "ADMINI_EXPENSES_MTD_L",
    "能源费用月实际": "ENERGY_EXPENSES_MTD_A",
    "能源费用月预算": "ENERGY_EXPENSES_MTD_B",
    "能源费用月同期": "ENERGY_EXPENSES_MTD_L",
    "人工成本月实际": "PEOPLE_COST_MTD_A",
    "人工成本月预算": "PEOPLE_COST_MTD_B",
    "人工成本月同期": "PEOPLE_COST_MTD_L",
    "经营利润年实际": "OPERATING_PROFIT_YTD_A",
    "经营利润年预算": "OPERATING_PROFIT_YTD_B",
    "经营利润年同期": "OPERATING_PROFIT_YTD_L",
    "总收入年实际": "TOTAL_INCOME_YTD_A",
    "总收入年预算": "TOTAL_INCOME_YTD_B",
    "总收入年同期": "TOTAL_INCOME_YTD_L",
    "餐饮利润月实际": "RESTAURANT_PROFIT_MTD_A",
    "餐饮利润月预算": "RESTAURANT_PROFIT_MTD_B",
    "餐饮利润月同期": "RESTAURANT_PROFIT_MTD_L",
    "客房利润月实际": "ROOM_PROFIT_MTD_A",
    "客房利润月预算": "ROOM_PROFIT_MTD_B",
    "客房利润月同期": "ROOM_PROFIT_MTD_L",
}
...
def fallback_rows(sql_upper: str) -> list[dict[str, Any]]:
    if "ADS_HOTEL_PNL_DETAIL_WIDE" in sql_upper:
        return [
            {"hotel_name": "示例酒店A", "dept": "客房部", "account_name": "客房收入", "actual_value": 420, "compare_value": 500, "diff_value": -80, "diff_rate": -0.16},
            {"hotel_name": "示例酒店A", "dept": "餐饮部", "account_name": "餐饮成本", "actual_value": 210, "compare_value": 180, "diff_value": 30, "diff_rate": 0.1667},
            {"hotel_name": "示例酒店A", "dept": "行政部", "account_name": "人工成本", "actual_value": 165, "compare_value": 140, "diff_value": 25, "diff_rate": 0.1786},
        ]
    return [
        {"hotel_name": "示例酒店A", "actual_value": 100, "compare_value": 120, "diff_rate": -0.1667},
        {"hotel_name": "示例酒店B", "actual_value": 130, "compare_value": 150, "diff_rate": -0.1333},
    ]
...
def db_query(payload: Req):
    ...
    try:
        ...
        if not rows:
            rows = fallback_rows(sql_upper)
            return {"rows": rows, "row_count": len(rows), "source": "fallback"}
